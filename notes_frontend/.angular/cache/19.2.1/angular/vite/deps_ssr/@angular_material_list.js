...
} from "./chunk-IKGOUICM.js";
import {
  coerceBooleanProperty
} from "./chunk-HBC6OKUB.js";
import {
  NG_VALUE_ACCESSOR
} from "./chunk-B3HC4B5Q.js";
import "./chunk-NALBXSHX.js";
import {
  A,
  CdkObserveContent,
  ENTER,
...
var MatListItemBase = class _MatListItemBase {
  ...
  _disabled = false;
  _subscriptions = new import_rxjs5.Subscription();
  ...
  _monitorProjectedLinesAndTitle() {
    this._ngZone.runOutsideAngular(() => {
      this._subscriptions.add((0, import_rxjs5.merge)(this._lines.changes, this._titles.changes).subscribe(() => this._updateItemLines(false)));
    });
  }
  /**
